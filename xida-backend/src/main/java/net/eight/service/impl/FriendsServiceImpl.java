...
import net.eight.mapper.FriendsMapper;
import net.eight.model.domain.Friends;
import net.eight.model.domain.User;
import net.eight.model.request.FriendAddRequest;
import net.eight.model.vo.FriendsRecordVO;
import net.eight.service.FriendsService;
...
import static net.eight.constants.FriendConstant.AGREE_STATUS;
import static net.eight.constants.FriendConstant.DEFAULT_STATUS;
import static net.eight.constants.FriendConstant.EXPIRED_STATUS;
import static net.eight.constants.FriendConstant.MAXIMUM_APPLY_TIME;
import static net.eight.constants.FriendConstant.MAXIMUM_REMARK_LENGTH;
import static net.eight.constants.FriendConstant.NOT_READ;
import static net.eight.constants.FriendConstant.READ;
import static net.eight.constants.FriendConstant.REVOKE_STATUS;
import static net.eight.constants.RedissonConstant.APPLY_LOCK;
...
import static net.eight.utils.StringUtils.stringJsonListToLongSet;
