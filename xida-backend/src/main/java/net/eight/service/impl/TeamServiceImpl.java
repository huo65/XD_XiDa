...
import net.eight.mapper.TeamMapper;
import net.eight.model.domain.Team;
import net.eight.model.domain.User;
import net.eight.model.domain.UserTeam;
import net.eight.model.enums.TeamStatusEnum;
import net.eight.model.request.TeamCoverUpdateRequest;
import net.eight.model.request.TeamJoinRequest;
import net.eight.model.request.TeamQueryRequest;
import net.eight.model.request.TeamQuitRequest;
import net.eight.model.request.TeamUpdateRequest;
import net.eight.model.vo.TeamVO;
...
import net.eight.utils.FileUtils;
...
import static net.eight.constants.TeamConstants.MAXIMUM_DESCRIPTION_LEN;
import static net.eight.constants.TeamConstants.MAXIMUM_JOINED_TEAM;
import static net.eight.constants.TeamConstants.MAXIMUM_JOINED_USER_AVATAR_NUM;
import static net.eight.constants.TeamConstants.MAXIMUM_MEMBER_NUM;
import static net.eight.constants.TeamConstants.MAXIMUM_PASSWORD_LEN;
import static net.eight.constants.TeamConstants.MAXIMUM_TEAM_NUM;
import static net.eight.constants.TeamConstants.MAXIMUM_TITLE_LEN;
