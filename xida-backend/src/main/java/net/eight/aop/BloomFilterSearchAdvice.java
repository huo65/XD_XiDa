...
public class BloomFilterSearchAdvice {
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* net.eight.controller.UserController.getUserById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* net.eight.controller.TeamController.getTeamById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* net.eight.controller.TeamController.getTeamMemberById(..))")
     ...
     * @param joinPoint 连接点
     */
    @Before("execution(* net.eight.controller.BlogController.getBlogById(..))")
